const TRAINERS = [
  {
    id: 0, icon: '💪', name: 'Arjun Mehta', role: 'CrossFit & HIIT Coach',
  ...
  {
    id: 1, icon: '🧘', name: 'Priya Sharma', role: 'Yoga & Wellness Coach',
  ...
  {
    id: 2, icon: '🏋️', name: 'Rohan Das', role: 'Strength & Power Coach',
  ...
  {
    id: 3, icon: '🥗', name: 'Meera Nair', role: 'Nutrition Coach',
  ...
  {
    id: 4, icon: '🏃', name: 'Vikram Singh', role: 'Endurance Specialist',
